            ...
            <form method="post" action="{{ route('commande_client.store')}}">
                ...
                <div class="card-body">    
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            <label class="ul-form__label" for="type">Nature commande:</label>
                            ...
                            @if ($errors->has('type'))
                                    ...
                                    @else    
                                    <small class="ul-form__text form-text" id="">
                                        Choisissez la nature de la commande svp!
                                    </small>
                                    @endif
                        </div>
                        <div class="form-group col-md-4">
                            <label class="ul-form__label" for="canal_reception">Canal de réception:</label>
