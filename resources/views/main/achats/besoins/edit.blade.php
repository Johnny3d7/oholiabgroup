...
@section('title', 'Edition entrepot -')
...
<div class="row justify-content-center">
    <div class="col-md-6 col-offset-3">
        <div class="card mb-4">
            <div class="card-body">
                <div class="card-title mb-3 ">Formulaire de modification de l'entrepôt <a href="{{ route('stock.entrepots.show',$entrepot)}}">{{ $entrepot->ref }}</a></div>
                <form method="put" action="{{ route('stock.entrepots.update',['slug'=> $entrepot->slug])}}">
                    @csrf
                    @method('PUT')
                    <div class="row">
