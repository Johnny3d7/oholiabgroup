                                    ...
                                    <table class="table table-hover mb-4">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <p>Date de réception : {{ ucwords((new Carbon\Carbon($commande->livraisons->first()->created_at))->locale('fr')->isoFormat('DD/MM/YYYY')) }}</p>
                                                    <p>Nom et prénom(s) : {{ $commande->livraisons->first()->livreur->nom }}</p>
                                                    <p class="mt-5 mb-5"><strong>Visa</strong> </p>
                                                </td>
                                            </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td scope="row">
                                                    ...
                                                    <p>Date de réception : {{ ucwords((new Carbon\Carbon($commande->livraisons->first()->date_reception_client))->locale('fr')->isoFormat('DD/MM/YYYY')) }}</p>
                                                    @endif
                                                    <p>Nom et prénom(s) : {{ $commande->entreprise->nom }}</p>
                                                    <p class="mt-5 mb-5"><strong>Visa</strong> </p>
                                                </td>
                                                <td>
                                                    <p>Date de réception : {{ ucwords((new Carbon\Carbon($commande->livraisons->first()->created_at))->locale('fr')->isoFormat('DD/MM/YYYY')) }}</p>
