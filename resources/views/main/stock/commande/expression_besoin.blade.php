        ...
        <div class="col-md-12 mb-4">
            <div class="card text-left">
                <div class="card-header text-right bg-transparent">
                    <button class="btn btn-primary btn-md m-1" type="button" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="i-Add-User text-white mr-2"></i> Etablir une fiche</button>
                </div>
                <!-- begin::modal-->
                        ...
                        <table class="display table" id="ul-contact-list" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>+88012378478</td>
                                    <td><a class="badge badge-primary m-2 p-2" href="#">Comptabilité</a></td>
                                    <td>20</td>
                                    <td>April 25, 2019</td>
                                    ...
                                    <td><a href="#"><button class="btn btn-outline-info m-1" type="button">Détail</button></a></td>
