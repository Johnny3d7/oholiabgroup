...
@section('content')
    <div class="row mb-4">
        {{-- <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-icon-bg card-icon-bg-info o-hidden mb-4 hoverChange" data-color="info" data-link="{{ route('parcauto.besoins.index', ['target' => 'en attente']) }}">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-icon-bg card-icon-bg-success o-hidden mb-4 hoverChange" data-color="success" data-link="{{ route('parcauto.besoins.index', ['target' => 'validé']) }}">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-icon-bg card-icon-bg-danger o-hidden mb-4 hoverChange" data-color="danger" data-link="{{ route('parcauto.besoins.index', ['target' => 'refusé']) }}">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-icon-bg card-icon-bg-warning o-hidden mb-4 hoverChange" data-color="warning" data-link="{{ route('parcauto.besoins.index', ['target' => 'annulé']) }}">
                <div class="card-body text-center"><i class="i-Close"></i>
                    <div class="content">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4 hoverChange" data-color="primary" data-link="{{ route('parcauto.fournisseurs.index') }}">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4 hoverChange" data-color="primary">
                <div class="card-body text-center">
                    {{-- <i class="i-Store-2"></i> --}}
                    <div class="content">
                        <p class="text-muted mt-2 mb-0">Nbre de véhicules</p>
                        <p class="text-primary text-24 line-height-1 mb-2">{{ $vehicles->count() }}</p>
                    </div>
                </div>
                <div class="row bg-primary pt-1"></div>
            </div>
