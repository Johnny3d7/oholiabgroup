@extends('main.parcinfo.partials.main',[
    'pageTitle' => "Ajout d'un nouvel appareil"
])
...
<div class="row">
    <div class="container-fluid">
        <section class="ul-product-detail__box">
            <div class="row">
                    <div class="col-lg-3 col-md-3 mt-1 mb-4 text-center">
                        <a href="{{ route('parcinfo.devices.index')}}">
                        <div class="card">
                            <div class="card-body">
                                <div class="ul-product-detail__border-box">
                                    ...
                                    <h5 class="heading">Liste des appareils</h5>
                                    <p class="text-muted text-12">Afficher la liste de tous les appareils.</p>
                                </div>
                            </div>
                        </div>
                    </a>
        ...
        <div class="card animate__animated animate__backInDown">
            ...
            <h3 class="card-title">Ajout d'un nouvel appareil</h3>
            </div>
            <!-- begin::form-->
            <form method="post" action="{{ route('parcinfo.devices.store')}}" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group col-lg-3 col-md-6">
                            ...
                            <small class="ul-form__text form-text" id="">
                                Entrez la reference de l'appareil svp!
                            </small>
                        ...
                        <div class="form-group col-lg-3 col-md-6">
                            ...
                            <small class="ul-form__text form-text" id="">
                                Entrez la date d'émission de l'appareil svp!
                            </small>
                        ...
                        <div class="form-group col-lg-3 col-md-6">
                            ...
                            <small class="ul-form__text form-text" id="">
                                Entrez la montant de l'appareil svp!
                            </small>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <textarea class="form-control" name="description" id="description" cols="30" rows="9" placeholder="Veuillez donner une description de l'appareil (Ce champs est facultatif)">@if (old('description')) {{ old('description') }} @endif</textarea>
                        </div>
                    </div>
                </div>
