                    ...
                    <div class="tab-pane fade show active" id="invoice" role="tabpanel" aria-labelledby="invoice-tab">
                        ...
                        <div id="print-area">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="row">
                                        <div class="col-md-8" style="border: 5px solid #332a6c; text-align:center; width:50% ">
                                            <strong style="color: #332a6c; font-size:40px; font-weight:800; font-family: Arial black !important;">BON DE LIVRAISON</strong>    
                                        </div>
                                        <div class="col-md-12 mt-5" style="color: #332a6c; font-family: Cambria !important;font-size:20px;">
                                            <div class="row">
                                                <div class="col-md-6 ">
                                                    <p style="font-weight:300;">N° Client : {{ $commande->client->nom }}</p>
                                                ...
                                                <div class="col-md-5" style="border: 3px solid #332a6c;border-radius:30px;">
                                                    <p style="font-weight:300;">Fournisseur : OHOLIAB GROUP</p>
                                                    <p style="font-weight:300;">Adresse : Riviera 3</p>
                                                    <p style="font-weight:300;">Contact :..............................</p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 ">
                                                    <p style="font-weight:600;">Date livraison : {{ $commande->date_livraison }}</p>   
                                                </div>
                                            </div>
                                        </div>
                                    </div>
