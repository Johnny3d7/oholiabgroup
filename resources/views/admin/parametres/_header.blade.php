<a href="javascript:void(0);" class="mr-3" data-toggle="modal" data-target="#add_{{ $type }}_modal" style="text-decoration: none !important;">
...
<a href="{{ route('admin.'.$model.$type.'s.index') }}" class="mr-3">
