...
<ul class="metismenu" id="menu">
    ...
    <li class="Ul_li--hover"><a class="has-arrow" href="#" aria-expanded="false"><i class="i-Bar-Chart text-20 mr-2 text-muted"></i><span class="item-name text-15 text-muted">Produits</span></a>
    ...
    <li class="Ul_li--hover"><a href="{{ route('admin.icons.index') }}"><i class="i-Environmental-3 text-20 mr-2 text-muted"></i><span class="item-name text-15 text-muted">Icons</span></a></li>
