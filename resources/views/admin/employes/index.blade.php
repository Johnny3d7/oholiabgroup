                            ...
                            @foreach ($employes as $id => $employe)    
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($employe->user)
                                            <img class="rounded-circle m-0 avatar-sm-table" src="{{ asset($employe->user->image()) }}" alt="" style="height: 2rem; width: 2rem;">
                                        @else
                                    ...
                                    <td>
                                        <a href="{{ route('admin.employes.show', $employe) }}" class="btn btn-info" type="button"><i class="nav-icon i-Eye"></i></a>
