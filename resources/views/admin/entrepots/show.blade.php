                                    ...
                                    @forelse ($products as $product)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- <a href="{{ route('stock.products.destroy',['slug'=>$product->id]) }}"><button class="btn btn-outline-danger m-1" type="button">Supprimer</button></a> -->
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                        ...
                        <form method="post" action="{{ route('stock.entrepots.store')}}">
                            ...
                            <div class="row">
                                <div class="col-md-3 form-group mb-2">
                                    ...
                                    <input class="form-control @error('source') is-invalid @enderror" id="source" name="id_entrepot_source" value="{{ $entrepot->ref }}" type="text" required readonly />
