<div class="sidebar-panel bg-white" style="background-image: url({{ url('images/sidebar2.jpg') }}) !important; background-position: 70% 20% !important; ">
    <div class="gull-brand pr-3 text-center mt-4 mb-2 d-flex justify-content-center align-items-center"><img class="pl-3" style="height: 50px; width:auto;" src="{{ url('images/logoakebie1.png') }}"  alt="alt" />
